package ipcasergio.am2.taskcreateacustomview
...
class DialView @JvmOverloads constructor(
    ...
    defSaleAttr : Int = 0
) : View( context, attrs, defSaleAttr) {
    ...
    private val paint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        ...
        private val pointPosition: PointF = PointF(0.0F, 0.0F)
          ...
          private var fanSpeedLowColor : Int
          private var fanSpeedMediumColor : Int
          private var fanSpeedMaxColor : Int
